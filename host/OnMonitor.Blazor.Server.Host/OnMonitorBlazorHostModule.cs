...
using OnMonitor.Blazor.Server.Host.Menus;
...
[DependsOn(
    ...
    typeof(OnMonitorBlazorServerModule)
)]
    ...
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
        {
            options.AddAssemblyResource(
                ...
                typeof(OnMonitorDomainModule).Assembly,
                typeof(OnMonitorDomainSharedModule).Assembly,
                typeof(OnMonitorApplicationModule).Assembly,
                typeof(OnMonitorApplicationContractsModule).Assembly,
                typeof(OnMonitorBlazorHostModule).Assembly
            );
        });
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        Configure<AbpBundlingOptions>(options =>
        {
                ...
                bundle =>
                {
                    bundle.AddFiles("/blazor-global-styles.css");
                        ...
                        bundle.AddFiles("/OnMonitor.Blazor.Server.Host.styles.css");
                }
            );
        });
        ...
        if (hostingEnvironment.IsDevelopment())
        {
            Configure<AbpVirtualFileSystemOptions>(options =>
            {
                ...
                options.FileSets.ReplaceEmbeddedByPhysical<OnMonitorBlazorHostModule>(hostingEnvironment.ContentRootPath);
            });
        }
